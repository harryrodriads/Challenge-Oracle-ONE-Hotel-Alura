...
public class ReservasView extends JFrame {
	...
	private void salvarReserva() {
		...
		Reserva novaReserva = new Reserva(java.sql.Date.valueOf(dataEntrada), java.sql.Date.valueOf(dataSaida),
				txtValor.getText(), txtFormaPagamento.getSelectedItem().toString());
		reservaController.salvar(novaReserva);
		
		JOptionPane.showMessageDialog(contentPane,"Registro Salvo com Sucesso! Número de Reserva " + novaReserva.getId().toString());
	...
	public void calcularValor(JDateChooser dataEntrada, JDateChooser dataSaida) {
		if(dataEntrada.getDate()!= null && dataSaida.getDate() != null) {
			if(dataEntrada.getDate().after(dataSaida.getDate())) {
				JOptionPane.showMessageDialog(null, "A Data de Entrada não pode ser depois da Data de Saída!");
			}
